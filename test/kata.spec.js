describe("SurvivorGame", function () {
	describe("play",function(){
		...
		it("Given 7 persons with step size 3, expect 4th person survivor", function() {
			// arrange
			let totalPeople = 7;
			let stepSize = 3;
			let game = new SurvivorGame();
		...
		it("Given 9 persons with step size 3, expect 1st person survivor", function() {
			// arrange
			let totalPeople = 9;
			let stepSize = 3;
			let game = new SurvivorGame();
		...
		it("Given 5 persons with step size 2, expect 1st person survivor", function() {
			// arrange
			let totalPeople = 5;
			let stepSize = 2;
			let game = new SurvivorGame();
